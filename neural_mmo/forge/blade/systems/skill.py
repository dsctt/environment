...
class Melee(CombatSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Melee(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)

class Range(CombatSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Range(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)

class Mage(CombatSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Mage(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)
...
class Fishing(HarvestSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Fishing(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)
...
class Herbalism(HarvestSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Herbalism(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)
...
class Prospecting(HarvestSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Prospecting(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)
...
class Carving(HarvestSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Carving(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)
...
class Alchemy(HarvestSkill):
   def __init__(self, ent, skillGroup):
      self.level = Static.Entity.Alchemy(ent.dataframe, ent.entID)
      super().__init__(ent, skillGroup)

...
from testhelpers import ScriptedAgentTestConfig, ScriptedAgentTestEnv, are_observations_equal, are_actions_equal
...
class TestDeterminism(unittest.TestCase):
  ...
  def test_func_are_observations_equal(self):
    ...
    self.assertTrue(are_actions_equal(self.actions_src[0], self.actions_src[0]))
  ...
  def test_compare_actions(self):
    ...
    for t in range(len(self.actions_src)):
      self.assertTrue(are_actions_equal(self.actions_src[t], self.actions_rep[t]))
